    ...
    <section className="relative overflow-hidden bg-background text-foreground py-20 border-t border-border">
      <div className="relative z-10 mx-auto max-w-5xl px-4 md:px-8">
        ...
        <div className="flex justify-center items-center gap-4 mb-16 relative z-30">
          <span className={cn("text-sm font-semibold transition-colors", !isYearly ? "text-foreground" : "text-foreground/50")}>Monthly</span>
          <button 
          ...
          <span className={cn("text-sm font-semibold transition-colors flex items-center gap-1.5", isYearly ? "text-accent" : "text-foreground/50")}>
            Yearly <span className="bg-accent/15 border border-accent/30 text-accent text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">Save 20%</span>
          </span>
        </div>
