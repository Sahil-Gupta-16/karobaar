  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        if ('node' in item) {
          const { node, href, ariaLabel, title } = item;
          ...
          const itemAriaLabel = ariaLabel ?? title;
        ...
        const { src, srcSet, sizes, width, height, alt, title, href } = item;
