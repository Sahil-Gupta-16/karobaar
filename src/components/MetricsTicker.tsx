  ...
  return (
    <section className="py-16 border-y border-border bg-surface/30 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <p className="text-xs font-mono text-foreground/50 uppercase tracking-widest mb-10">
          {kicker}
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 divide-y md:divide-y-0 md:divide-x divide-border">
          {stats.map((stat, idx) => (
            ...
            >
              ...
              <p className="text-sm md:text-base text-foreground/70 font-medium relative z-10">
                {stat.label}
              </p>
